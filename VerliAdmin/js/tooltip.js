...
function tt_Htm(tt, t_id, txt)
{
	...
	var t_y = '<DIV id="' + t_id + '" class="b1 bg_light left" style="padding:5px;position:absolute;z-index:1010;left:0px;top:0px;background-color:#CFDFDF;visibility:' + (tt_n4? 'hide' : 'hidden') + ';">';
	t_y += txt;
	t_y += '<\/DIV>';
	return t_y;
}
